...
import TableFacultades from './components/TableFacultades'
import FacultadRegister from './components/FacultadRegister'
...
toggleModal = () => {  
  ...
  render() {       
  const { modalView } = this.props.facultades
    ...
    <div className="content">     
        <div className="main-contenido">  
         <Row className="subi">          
          ...
          <NavItem>            
            <Link to="/admin/carreras" className="nav-link"> 
            <i className="fas fa-chevron-right"/>{' '}
            Carreras </Link>
          </NavItem>
          <NavItem>            
            <Link to="/admin/facultades" className="nav-link active"> 
...
export default connect(mapStateToProps,mapDispatchToProps)(facultades);