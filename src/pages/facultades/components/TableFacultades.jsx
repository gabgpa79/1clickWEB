...
class TableFacultades extends React.Component {  
  state = {      
      nroPagina:12,
      modalDelete: false,
      deleteId: 0
...
makeHttpRequestWithPage = (pageNumber,num) => {
    this.props.getData('FACULTAD_DATA','facultades',pageNumber,num)
} 
...
render() {    
  const { data, pagina, paginas, total } = this.props.facultades  
...
export default connect(mapStateToProps,mapDispatchToProps)(TableFacultades);